  ...
  return (
    ...
    <View style={styles.formStyle} >
      ...
      <View style={{marginVertical:10}} >
        ...
        <TextInput placeholder='Your name' placeholderTextColor={Colors.primary} keyboardType='default' value={email} onChangeText={(text) => setEmail(text)} style={styles.textFieldStyle} />
      </View>
      <View style={{marginVertical:10}} >
